...
public class Variaveis {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Inteiro = %d qualquer coisa %d\n", idade, idade);
		...
		System.out.printf("'%1.3f'%n", 40000.3214); // largura do nosso número como 1 e comprimento da parte decimal é 2;
